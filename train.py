...
config = {
    ...
    "intermediate_size": 4 * 48, # 4 * embedding_size
...
assert config["embedding_size"] % config["num_attention_heads"] == 0
assert config['intermediate_size'] == 4 * config['embedding_size']
